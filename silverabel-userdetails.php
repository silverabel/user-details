...
class User_Details_Plugin {
  public static function add_rewrite() {
    add_rewrite_endpoint('userdetails', EP_ROOT);
    flush_rewrite_rules();
  }
  ...
  public static function userdetails_parse( $request ) {
    if( array_key_exists( 'userdetails', $request->query_vars ) ) {
...
add_action( 'parse_request', 'User_Details_Plugin::userdetails_parse');
